    ...
    <c:param name="content">
        <c:choose>
            <c:when test="${report != null}">
                ...
                <c:if test="${sessionScope.login.employee.id == report.employee.id}">
                    <p><a href="<c:out value='/report/edit?id=${report.id}' />" >この日報を編集する</a>
                </c:if>
            </c:when>
            <c:otherwise>
        ...
        <p><a href="<c:out value='/reports/index' />" >一覧に戻る</a></p>
    </c:param>
</c:import>